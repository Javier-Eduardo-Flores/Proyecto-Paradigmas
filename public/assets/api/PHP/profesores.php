...
Endpoint encargado de mandar la consulta sobre los profesores a Prolog, valiendose del servicio
Consultas-JSON
@author Machigua
...
const consulta = "swipl -s \"%s\" -g \"forall(profesor(N,I,J), format('~w,~w,~w~n', [N,I,J]))\" -t halt | python3 %s Profesores Nombre,DNI,Correo";

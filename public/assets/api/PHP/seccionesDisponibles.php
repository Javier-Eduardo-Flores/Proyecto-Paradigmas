...
$consulta = "swipl --quiet -g \"consult('%s'), consult('%s'), (forall('Generar Secciones'(Clase,Profesor,Aula), format('~w,~w,~w~n',[Clase,Profesor,Aula])) ; true)\" -t halt | python3 %s Secciones Clase,Profesor,Aula";
